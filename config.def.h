...
/* static const char *startslstatus[] = {"/home/carter/.apps/slstatus.sh", NULL}; */
...
static const char *audiodown[] = {"pactl", "set-sink-volume", "@DEFAULT_SINK@",
                                  "-10%", NULL};
static const char *missilealert[] = {
    "mpv", "/home/carter/Videos/SFX/missile-alert.mp3", NULL};
